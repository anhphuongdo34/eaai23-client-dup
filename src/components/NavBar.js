...
const NavBar = (props) => {
    ...
    return (
        <header className="bg-gray-900 z-40 fixed top-0 left-0 right-0 w-full">
                ...
                <div className="flex items-center justify-between h-16">
                    ...
                    <div className="hidden md:block">
                        ...
                        <ul className="flex items-center justify-between gap-5 text-sm">
                            ...
                            <li>
                            <a className="text-white transition hover:text-white/75" href="/capture">
                                {phrases.MENU_CAPTURE}
                            </a>
                            </li>

                            <li>
                            <a className="text-white transition hover:text-white/75" href="/futureFeature">
                            ...
                            <li>
                            <a className="text-white transition hover:text-white/75" href="https://forms.gle/pLegiwR99FcFEfUh6" target="_blank">
                                {phrases.MENU_SURVEY}
                            </a>
                            </li>
                        </ul>
